...
async function generateSample() {
    ...
    const choix4_1 = await createParagraph(story, "[Titre Choix 4.1] [CHOICEONLY] Revenir au début de l'histoire", username, choix4.id, story.idParagrapheInitial, true);
    
    // un choix qui boucle sur lui-même
    const choix5 = await createParagraph(story, "[Titre Choix 5] [CHOICEONLY] Choix boucleur conclusion", username, story.idParagrapheInitial, story.idParagrapheInitial, true);
    ...
    const choix6_1_1_1_1 = await createParagraph(story, "[Titre Choix 6.1.1.1.1] [CHOICEONLY]?", username, choix6_1_1_1.id, choix6.id, true);
}
